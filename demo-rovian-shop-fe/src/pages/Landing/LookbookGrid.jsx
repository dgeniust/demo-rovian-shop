      ...
      <div className="max-w-[1400px] mx-auto z-10 relative">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-['Roboto_Slab'] font-[350] tracking-tighter text-white italic leading-tight">
            Bento <span className="text-zinc-500 not-italic">Lookbook</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-[1200px]">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60 group-hover:opacity-100 transition-opacity duration-1000 flex items-end p-12">
              <span className="text-white text-[10px] tracking-[0.5em] uppercase border-l border-zinc-400 pl-4 font-medium">
                {LOOKBOOK_DATA[0].tag}
              </span>
            </div>
          </motion.div>
          ...
          {[LOOKBOOK_DATA[3], LOOKBOOK_DATA[2]].map((img, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 group-hover:opacity-100 transition-all duration-700 backdrop-blur-[2px]">
                <span className="text-white text-[9px] tracking-[0.5em] uppercase font-bold border-b border-zinc-400 pb-1">
                  Xem Chi Tiết
                </span>
              </div>
            </motion.div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div className="md:col-span-2 h-[500px] overflow-hidden group relative bg-zinc-900 border border-zinc-800/50">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <h2 className="text-white text-7xl md:text-[10rem] font-serif font-light tracking-[-0.05em] mix-blend-overlay opacity-60 group-hover:opacity-100 transition-all duration-[1500ms]">
                ROVIAN
              </h2>
            </div>
          </motion.div>
